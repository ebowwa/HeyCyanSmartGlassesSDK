...
public final class WifiP2pManagerSingleton {
    ...
    /* compiled from: WifiP2pManagerSingleton.kt */
    @Metadata(m606d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u001e\n\u0002\u0018\u0002\n\u0002\b\u0006\bf\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H&J\u0010\u0010\u0004\u001a\u00020\u00032\u0006\u0010\u0005\u001a\u00020\u0006H&J\b\u0010\u0007\u001a\u00020\u0003H&J\u0010\u0010\b\u001a\u00020\u00032\u0006\u0010\u0005\u001a\u00020\u0006H&J\b\u0010\t\u001a\u00020\u0003H&J\u0012\u0010\n\u001a\u00020\u00032\b\u0010\u000b\u001a\u0004\u0018\u00010\fH&J\b\u0010\r\u001a\u00020\u0003H&J\u0010\u0010\u000e\u001a\u00020\u00032\u0006\u0010\u0005\u001a\u00020\u0006H&J\b\u0010\u000f\u001a\u00020\u0003H&J\u0016\u0010\u0010\u001a\u00020\u00032\f\u0010\u0011\u001a\b\u0012\u0004\u0012\u00020\u00130\u0012H&J\u0012\u0010\u0014\u001a\u00020\u00032\b\u0010\u0015\u001a\u0004\u0018\u00010\u0013H&J\b\u0010\u0016\u001a\u00020\u0003H&J\b\u0010\u0017\u001a\u00020\u0003H&J\b\u0010\u0018\u001a\u00020\u0003H&¨\u0006\u0019"}, m607d2 = {"Lcom/sdk/glassessdksample/ui/wifi/p2p/WifiP2pManagerSingleton$WifiP2pCallback;", "", "cancelConnect", "", "cancelConnectFail", "reason", "", "connecting", "onConnectRequestFailed", "onConnectRequestSent", "onConnected", "info", "Landroid/net/wifi/p2p/WifiP2pInfo;", "onDisconnected", "onPeerDiscoveryFailed", "onPeerDiscoveryStarted", "onPeersChanged", "peers", "", "Landroid/net/wifi/p2p/WifiP2pDevice;", "onThisDeviceChanged", "device", "onWifiP2pDisabled", "onWifiP2pEnabled", "retryAlsoFailed", "app_release"}, m608k = 1, m609mv = {1, 9, 0}, m611xi = 48)
    ...
    public final void connectToDevice(WifiP2pDevice device) {
        ...
        try {
            resetPeerDiscovery();
            if (this.connected) {
                Log.d("WifiP2pManagerSingleton", "P2P已经连接上了，直接返回");
                return;
            }
            if (this.connecting) {
                ...
                Log.d("WifiP2pManagerSingleton", "P2P正在连接,不调用连接返回");
                return;
            }
            ...
            Log.d("WifiP2pManagerSingleton", "已经在连接设备:" + device.deviceName);
    ...
    /* compiled from: WifiP2pManagerSingleton.kt */
    @Metadata(m606d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\b\u0002\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\b\u0010\u0005\u001a\u00020\u0006H\u0016R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0007"}, m607d2 = {"Lcom/sdk/glassessdksample/ui/wifi/p2p/WifiP2pManagerSingleton$DiscoveryTimeOut;", "Ljava/lang/Runnable;", "outer", "Lcom/sdk/glassessdksample/ui/wifi/p2p/WifiP2pManagerSingleton;", "(Lcom/sdk/glassessdksample/ui/wifi/p2p/WifiP2pManagerSingleton;)V", "run", "", "app_release"}, m608k = 1, m609mv = {1, 9, 0}, m611xi = 48)
    private static final class DiscoveryTimeOut implements Runnable {
        ...
        public void run() {
            Log.d("WifiP2pManagerSingleton", "内部扫描重试连接:" + this.outer.discoveryRetry);
            if (this.outer.discoveryRetry < 1) {
                Log.d("WifiP2pManagerSingleton", "内部扫描重试连接一次");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: WifiP2pManagerSingleton.kt */
    @Metadata(m606d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\b\u0002\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\b\u0010\u0005\u001a\u00020\u0006H\u0016R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0007"}, m607d2 = {"Lcom/sdk/glassessdksample/ui/wifi/p2p/WifiP2pManagerSingleton$ConnectTimeOut;", "Ljava/lang/Runnable;", "outer", "Lcom/sdk/glassessdksample/ui/wifi/p2p/WifiP2pManagerSingleton;", "(Lcom/sdk/glassessdksample/ui/wifi/p2p/WifiP2pManagerSingleton;)V", "run", "", "app_release"}, m608k = 1, m609mv = {1, 9, 0}, m611xi = 48)
        ...
        public void run() {
            ...
            if (this.outer.connectRetry < 1) {
                ...
                if (wifiP2pDevice != null) {
                    Log.d("WifiP2pManagerSingleton", "内部连接重试连接一次");
                    this.outer.connectToDevice(wifiP2pDevice);
                }
                this.outer.connectRetry++;
                return;
            }
            Log.d("WifiP2pManagerSingleton", "不重连，等外部超时");
    ...
    /* compiled from: WifiP2pManagerSingleton.kt */
    @Metadata(m606d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0006\u0010\u0005\u001a\u00020\u0004R\u0010\u0010\u0003\u001a\u0004\u0018\u00010\u0004X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0006"}, m607d2 = {"Lcom/sdk/glassessdksample/ui/wifi/p2p/WifiP2pManagerSingleton$Companion;", "", "()V", "instance", "Lcom/sdk/glassessdksample/ui/wifi/p2p/WifiP2pManagerSingleton;", "getInstance", "app_release"}, m608k = 1, m609mv = {1, 9, 0}, m611xi = 48)
