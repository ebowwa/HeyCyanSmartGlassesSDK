...
import com.glasssutdio.wear.ota.OTAActivity1;
...
public final class OTAActivity1 extends BaseSettingActivity implements WifiP2pManagerSingleton.WifiP2pCallback {
    ...
    public OTAActivity1() {
        final OTAActivity1 oTAActivity1 = this;
        final Qualifier qualifier = null;
        final Object[] objArr = 0 == true ? 1 : 0;
        this.otaViewModel = LazyKt.lazy(new Function0<OTAViewModel>() { // from class: com.glasssutdio.wear.ota.OTAActivity1$special$$inlined$viewModel$default$1
            ...
            public final OTAViewModel invoke() {
                return LifecycleOwnerExtKt.getViewModel(oTAActivity1, Reflection.getOrCreateKotlinClass(OTAViewModel.class), qualifier, objArr);
            }
        });
        ...
        this.requestPermissionLaunch = registerForActivityResult(new ActivityResultContracts.RequestMultiplePermissions(), new ActivityResultCallback() { // from class: com.glasssutdio.wear.ota.OTAActivity1$$ExternalSyntheticLambda3
            @Override // androidx.activity.result.ActivityResultCallback
            public final void onActivityResult(Object obj) {
                OTAActivity1.requestPermissionLaunch$lambda$2(this.f$0, (Map) obj);
            }
        });
        this.PORT = 8080;
        this.wifiFirmWareName = "";
        this.dfuOpResult = new OTAActivity1$dfuOpResult$1(this);
    }
    ...
    private final void initViews() {
        ...
        activityOtaactivityBinding.appBack.setOnClickListener(new View.OnClickListener() { // from class: com.glasssutdio.wear.ota.OTAActivity1$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                OTAActivity1.initViews$lambda$4$lambda$3(this.f$0, view);
            }
        });
        ...
        if (getPowerManager(oTAActivity1) != null) {
            PowerManager powerManager = getPowerManager(oTAActivity1);
        ...
        getOtaViewModel().getUiState().observe(this, new OTAActivity1$sam$androidx_lifecycle_Observer$0(new Function1<OTAViewModel.FirmwareUI, Unit>() { // from class: com.glasssutdio.wear.ota.OTAActivity1.initViews.2
            {
                super(1);
            }
            ...
            public final void invoke2(final OTAViewModel.FirmwareUI firmwareUI) {
                ...
                if (firmwareUI != null) {
                    ...
                    if (firmwareUI.getRetCode() != 0) {
                        String string = OTAActivity1.this.getString(C0775R.string.ble_glass_14);
                        Intrinsics.checkNotNullExpressionValue(string, "getString(...)");
                        GlobalKt.showToast$default(string, 0, 1, null);
                        OTAActivity1.this.finish();
                    }
                    OTAActivity1.this.handler.removeCallbacks(OTAActivity1.this.runnable);
                    OTAActivity1.this.handler.postDelayed(OTAActivity1.this.runnable, DeviceOrientationRequest.OUTPUT_PERIOD_MEDIUM);
                    OTAActivity1.this.wifiFirmWareName = firmwareUI.getFileName();
                    final Ref.IntRef intRef = new Ref.IntRef();
                    if (OTAActivity1.this.getOtaViewModel().getWifiNotBle()) {
                        iCombineProgressBle = OTAActivity1.this.combineProgress((int) firmwareUI.getProgressBar(), 0, 0, 0, 1.0d, 0.0d, 0.0d, 0.0d);
                    } else {
                        iCombineProgressBle = OTAActivity1.this.combineProgressBle((int) firmwareUI.getProgressBar(), 0, 1.0d, 0.0d);
                    }
                    intRef.element = iCombineProgressBle;
                    ActivityOtaactivityBinding activityOtaactivityBinding3 = OTAActivity1.this.binding;
                    ...
                    ThreadExtKt.ktxRunOnUi(OTAActivity1.this, new Function1<OTAActivity1, Unit>() { // from class: com.glasssutdio.wear.ota.OTAActivity1.initViews.2.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        @Override // kotlin.jvm.functions.Function1
                        public /* bridge */ /* synthetic */ Unit invoke(OTAActivity1 oTAActivity12) {
                            invoke2(oTAActivity12);
                            return Unit.INSTANCE;
                        }

                        /* renamed from: invoke, reason: avoid collision after fix types in other method */
                        public final void invoke2(OTAActivity1 ktxRunOnUi) {
                    ...
                    if (firmwareUI.getSuccess()) {
                        ...
                        if (OTAActivity1.this.getOtaViewModel().getWifiNotBle()) {
                            OTAActivity1.this.handler.removeCallbacks(OTAActivity1.this.runnable);
                            OTAActivity1.this.wifiFirmWareName = firmwareUI.getFileName();
                            OTAActivity1.this.requestPermissionLaunch.launch(OTAActivity1.this.requestedPermissions);
                            return;
                        }
                        OTAActivity1.this.startOta(firmwareUI.getFileName());
                    }
                }
            }
        }));
        ...
        if (numValueOf == null || numValueOf.intValue() != 1) {
            this.handler.postDelayed(new Runnable() { // from class: com.glasssutdio.wear.ota.OTAActivity1$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    OTAActivity1.initViews$lambda$5(this.f$0);
                }
            }, 200L);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void initViews$lambda$4$lambda$3(OTAActivity1 this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.finish();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void initViews$lambda$5(OTAActivity1 this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    private final void startServer(final String ip) {
        ...
        new Thread(new Runnable() { // from class: com.glasssutdio.wear.ota.OTAActivity1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() throws IOException {
                OTAActivity1.startServer$lambda$8(ip, this);
            }
        }).start();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void startServer$lambda$8(String ip, final OTAActivity1 this$0) throws IOException {
        Intrinsics.checkNotNullParameter(ip, "$ip");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        try {
            final InetAddress byName = InetAddress.getByName(ip);
            this$0.serverSocket = new ServerSocket(this$0.PORT, 50, byName);
            this$0.runOnUiThread(new Runnable() { // from class: com.glasssutdio.wear.ota.OTAActivity1$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
                    OTAActivity1.startServer$lambda$8$lambda$6(byName, this$0);
                }
            });
            while (true) {
            ...
            e.printStackTrace();
            this$0.runOnUiThread(new Runnable() { // from class: com.glasssutdio.wear.ota.OTAActivity1$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    OTAActivity1.startServer$lambda$8$lambda$7(e);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void startServer$lambda$8$lambda$6(InetAddress inetAddress, OTAActivity1 this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public final void startSocOta() {
        ...
        LargeDataHandler.getInstance().glassesControl(new byte[]{2, 1, 5}, new ILargeDataResponse() { // from class: com.glasssutdio.wear.ota.OTAActivity1$$ExternalSyntheticLambda8
            @Override // com.oudmon.ble.base.communication.ILargeDataResponse
            public final void parseData(int i, BaseResponse baseResponse) {
                OTAActivity1.startSocOta$lambda$10(this.f$0, i, (GlassModelControlResponse) baseResponse);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void startSocOta$lambda$10(OTAActivity1 this$0, int i, final GlassModelControlResponse glassModelControlResponse) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        ...
        if (glassModelControlResponse.getDataType() == 1 && glassModelControlResponse.getGlassWorkType() == 5) {
            ...
            ThreadExtKt.ktxRunOnUi(this$0, new Function1<OTAActivity1, Unit>() { // from class: com.glasssutdio.wear.ota.OTAActivity1$startSocOta$1$1
                {
                    super(1);
                }

                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(OTAActivity1 oTAActivity1) {
                    invoke2(oTAActivity1);
                    return Unit.INSTANCE;
                }
    ...
    public final void startSocOtaServer(String ipAddress) {
        if (this.systemSuccess && this.bleCallbackSuccess) {
            ...
            LargeDataHandler.getInstance().writeIpToSoc("http://" + ipAddress + ":8080/" + this.wifiFirmWareName, new ILargeDataResponse() { // from class: com.glasssutdio.wear.ota.OTAActivity1$$ExternalSyntheticLambda5
                @Override // com.oudmon.ble.base.communication.ILargeDataResponse
                public final void parseData(int i, BaseResponse baseResponse) {
                    OTAActivity1.startSocOtaServer$lambda$11(i, (BatteryResponse) baseResponse);
                }
            });
            return;
        }
    ...
    public final void otaFail() {
        ThreadExtKt.ktxRunOnUi(this, new Function1<OTAActivity1, Unit>() { // from class: com.glasssutdio.wear.ota.OTAActivity1.otaFail.1
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(OTAActivity1 oTAActivity1) {
                invoke2(oTAActivity1);
                return Unit.INSTANCE;
    ...
    protected void onDestroy() {
        ...
        try {
            ...
            WifiP2pManagerSingleton.INSTANCE.getInstance().removeCallback();
            LargeDataHandler.getInstance().syncDeviceInfo(new ILargeDataResponse() { // from class: com.glasssutdio.wear.ota.OTAActivity1$$ExternalSyntheticLambda4
                @Override // com.oudmon.ble.base.communication.ILargeDataResponse
                public final void parseData(int i, BaseResponse baseResponse) {
                    OTAActivity1.onDestroy$lambda$12(i, (DeviceInfoResponse) baseResponse);
                }
            });
    ...
    /* compiled from: OTAActivity1.kt */
    @Metadata(m606d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\b\u0086\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016¨\u0006\u0005"}, m607d2 = {"Lcom/glasssutdio/wear/ota/OTAActivity1$MyRunnable;", "Ljava/lang/Runnable;", "(Lcom/glasssutdio/wear/ota/OTAActivity1;)V", "run", "", "app_release"}, m608k = 1, m609mv = {1, 9, 0}, m611xi = 48)
    ...
    /* compiled from: OTAActivity1.kt */
    @Metadata(m606d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0017¨\u0006\t"}, m607d2 = {"Lcom/glasssutdio/wear/ota/OTAActivity1$MyDeviceNotifyListener;", "Lcom/oudmon/ble/base/communication/bigData/resp/GlassesDeviceNotifyListener;", "(Lcom/glasssutdio/wear/ota/OTAActivity1;)V", "parseData", "", "cmdType", "", "response", "Lcom/oudmon/ble/base/communication/bigData/resp/GlassesDeviceNotifyRsp;", "app_release"}, m608k = 1, m609mv = {1, 9, 0}, m611xi = 48)
        ...
        public void parseData(int cmdType, GlassesDeviceNotifyRsp response) throws SocketException {
            ...
            if (b != 4) {
                if (b != 7) {
                    ...
                    OTAActivity1.this.bleCallbackSuccess = true;
                    String clientIPAddress = OTAActivity1.this.getClientIPAddress(string);
                    if (clientIPAddress != null) {
                        OTAActivity1.this.startSocOtaServer(clientIPAddress);
                        return;
                    }
                    return;
                }
                ...
                if (z) {
                    ActivityOtaactivityBinding activityOtaactivityBinding2 = OTAActivity1.this.binding;
                    if (activityOtaactivityBinding2 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("binding");
                        activityOtaactivityBinding2 = null;
                    }
                    activityOtaactivityBinding2.tvTitle.setText(OTAActivity1.this.getString(C0775R.string.ble_glass_28));
                    ActivityOtaactivityBinding activityOtaactivityBinding3 = OTAActivity1.this.binding;
                    if (activityOtaactivityBinding3 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("binding");
                        activityOtaactivityBinding3 = null;
                    ...
                    ActivityOtaactivityBinding activityOtaactivityBinding4 = OTAActivity1.this.binding;
                    if (activityOtaactivityBinding4 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("binding");
                    } else {
                    ...
                    StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
                    String string2 = OTAActivity1.this.getString(C0775R.string.ble_glass_29);
                    Intrinsics.checkNotNullExpressionValue(string2, "getString(...)");
                    String str = String.format(string2, Arrays.copyOf(new Object[]{"100"}, 1));
                    Intrinsics.checkNotNullExpressionValue(str, "format(...)");
                    textView.setText(str);
                    OTAActivity1.this.startBleOta();
            ...
            try {
                ActivityOtaactivityBinding activityOtaactivityBinding5 = OTAActivity1.this.binding;
                if (activityOtaactivityBinding5 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("binding");
                    activityOtaactivityBinding5 = null;
                }
                ViewKt.gone(activityOtaactivityBinding5.cslOtaWifi);
                ActivityOtaactivityBinding activityOtaactivityBinding6 = OTAActivity1.this.binding;
                if (activityOtaactivityBinding6 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("binding");
                    activityOtaactivityBinding6 = null;
                }
                ViewKt.visible(activityOtaactivityBinding6.groupOta);
                ActivityOtaactivityBinding activityOtaactivityBinding7 = OTAActivity1.this.binding;
                if (activityOtaactivityBinding7 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("binding");
                ...
                ActivityOtaactivityBinding activityOtaactivityBinding8 = OTAActivity1.this.binding;
                if (activityOtaactivityBinding8 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("binding");
                    activityOtaactivityBinding8 = null;
                }
                activityOtaactivityBinding8.tvTitle.setText(OTAActivity1.this.getString(C0775R.string.ble_glass_28));
                OTAActivity1.this.handler.removeCallbacks(OTAActivity1.this.runnable);
                OTAActivity1.this.handler.postDelayed(OTAActivity1.this.runnable, 60000L);
                int iCombineProgress = OTAActivity1.this.combineProgress(100, b2, b3, b4, 0.0d, 0.29d, 0.01d, 0.7d);
                ActivityOtaactivityBinding activityOtaactivityBinding9 = OTAActivity1.this.binding;
                ...
                ActivityOtaactivityBinding activityOtaactivityBinding10 = OTAActivity1.this.binding;
                ...
                StringCompanionObject stringCompanionObject2 = StringCompanionObject.INSTANCE;
                String string3 = OTAActivity1.this.getString(C0775R.string.ble_glass_29);
                Intrinsics.checkNotNullExpressionValue(string3, "getString(...)");
    ...
    /* compiled from: OTAActivity1.kt */
    @Metadata(m606d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\b\u0087\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016¨\u0006\u0005"}, m607d2 = {"Lcom/glasssutdio/wear/ota/OTAActivity1$P2pConnectFailRunnable;", "Ljava/lang/Runnable;", "(Lcom/glasssutdio/wear/ota/OTAActivity1;)V", "run", "", "app_release"}, m608k = 1, m609mv = {1, 9, 0}, m611xi = 48)
    public final class P2pConnectFailRunnable implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            if (OTAActivity1.this.failRetry < 3) {
                try {
                    XLog.m137i("p2p连接超时,准备再次走流程");
                    if (UserConfig.INSTANCE.getInstance().getDebug()) {
                        ThreadExtKt.ktxRunOnUi(this, new Function1<P2pConnectFailRunnable, Unit>() { // from class: com.glasssutdio.wear.ota.OTAActivity1$P2pConnectFailRunnable$run$1
                            @Override // kotlin.jvm.functions.Function1
                            public /* bridge */ /* synthetic */ Unit invoke(OTAActivity1.P2pConnectFailRunnable p2pConnectFailRunnable) {
                                invoke2(p2pConnectFailRunnable);
                                return Unit.INSTANCE;
                            }

                            /* renamed from: invoke, reason: avoid collision after fix types in other method */
                            public final void invoke2(OTAActivity1.P2pConnectFailRunnable ktxRunOnUi) {
                                Intrinsics.checkNotNullParameter(ktxRunOnUi, "$this$ktxRunOnUi");
                                GlobalKt.showToast$default("p2p连接超时,准备再次走流程", 0, 1, null);
                            }
                        });
                    }
                    OTAActivity1.this.systemSuccess = false;
                    OTAActivity1.this.bleCallbackSuccess = false;
                    OTAActivity1.this.startSocOta();
                } catch (Exception e) {
                    e.printStackTrace();
                }
                OTAActivity1.this.failRetry++;
                return;
            }
            if (UserConfig.INSTANCE.getInstance().getDebug()) {
                ThreadExtKt.ktxRunOnUi(this, new Function1<P2pConnectFailRunnable, Unit>() { // from class: com.glasssutdio.wear.ota.OTAActivity1$P2pConnectFailRunnable$run$2
                    @Override // kotlin.jvm.functions.Function1
                    public /* bridge */ /* synthetic */ Unit invoke(OTAActivity1.P2pConnectFailRunnable p2pConnectFailRunnable) {
                        invoke2(p2pConnectFailRunnable);
                        return Unit.INSTANCE;
            ...
            OTAActivity1.this.handler.removeCallbacks(OTAActivity1.this.p2pConnectFailRunnable);
            OTAActivity1.this.otaFail();
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void requestPermissionLaunch$lambda$2(OTAActivity1 this$0, Map it) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
